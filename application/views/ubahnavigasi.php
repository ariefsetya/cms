...
<div class="most-center">
	<legend><a href="<?php echo base_url("navigasi");?>"><i class="icon-arrow-left"></i></a> Ubah Navigasi</legend>
		...
		<table class="table">
			<tr>
				...
				<td><select name="parent" data-transform="input-control">
					...
					foreach ($a as $key) {
						?>
						<option <?php if($row['menu_parent']==$key['id']){echo"selected";} ?> value="<?php echo $key['id'];?>"><?php echo $key['menu_nama'];?></option>
						<?php
					}
					?>
				</select></td>
			...
			<tr>
				<td>Nama Menu</td>
				<td><input required value="<?php echo $row['menu_nama'];?>" name="nama" type="text" data-transform="input-control"></td>
				<td></td>
			</tr>
			<tr>
				<td>Link Tujuan</td>
				<td><input id="link" required value="<?php echo $row['menu_link'];?>" name="tujuan" type="text" data-transform="input-control"></td>
				<td><span onclick="$('#link').val('<?php echo base_url();?>')" class="button"> <i class="icon-home"></i> </span></td>
			</tr>
			<tr>
				<td>Icon</td>
				<td><input id="icon" value="<?php echo $row['menu_icon'];?>" readonly name="icon" type="text" data-transform="input-control"></td>
				<td><span onclick="coba()" class="button"> <i class="icon-search"></i> </span></td>
			</tr>
			<tr>
				<td>Aktif</td>
				<td><select name="aktif" data-transform="input-control">
					<option <?php if($row['menu_aktif']=="1"){echo"selected";} ?> value="1">Ya</option>
					<option <?php if($row['menu_aktif']=="0"){echo"selected";} ?> value="0">Tidak</option>
				</select></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><select name="hak" data-transform="input-control">
					<option <?php if($row['menu_tipe']=="0"){echo"selected";} ?> value="0">Pengguna</option>
					<option <?php if($row['menu_tipe']=="1"){echo"selected";} ?> value="1">Admin</option>
				</select></td>
				<td></td>
			</tr>
			<tr>
				<td>Indeks</td>
				<td><input required type="text" name="indeks" data-transform="input-control" value="<?php echo $row['menu_indeks'];?>"></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
